            ...
            <div>
              ...
              <div className="flex justify-center mt-6">
                <a
                  ...
                  className="inline-block px-8 py-4 bg-gradient text-white rounded-lg text-lg font-semibold tracking-wide hover:bg-gradient transition-transform transform hover:scale-105 shadow-lg border-2 border-gradient"
                >
                  Download My Resume
                </a>
              </div>
