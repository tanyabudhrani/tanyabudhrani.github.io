    ...
    <section id="about" className="py-20 bg-primary text-white">
      <div className="container mx-auto text-right">
        ...
        <div className="flex flex-col md:flex-row items-right md:items-start">
          ...
          />
          <div className="md:ml-20 text-left flex flex-col justify-between">
            <div>
            ...
            {/* Make the button inline with the content by flex alignment */}
            <a
              href="https://drive.google.com/file/d/1_Djkp0_x8UF9px_c_ZSTFrG_5hTHPo76/view?usp=drive_link"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-8 py-4 bg-gradient text-white rounded-lg text-lg font-semibold tracking-wide hover:bg-gradient transition-transform transform hover:scale-105 shadow-lg border-2 border-gradient self-start md:self-end"
            >
              Download My Resume
            </a>
          </div>
